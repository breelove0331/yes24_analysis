<style>
    ...
    h1 { border-bottom: 2px solid #1e3a8a; padding-bottom: 10px; }
    h2 { border-left: 5px solid #3b82f6; padding-left: 12px; }
...
<h2>0. 분석 목적 및 배경 (Analysis Purpose)</h2>
...
<div class="section-block">
<h2>📊 핵심 인사이트 요약 (Executive Summary)</h2>
...
<div class="section-block">
<h2>1. 데이터 개요 (Data Overview)</h2>
<table>
<thead>
<tr><th style="text-align:center">항목</th><th>내용</th></tr>
</thead>
<tbody>
<tr><td style="text-align:center"><b>분석 대상</b></td><td>YES24 IT/컴퓨터 카테고리 실시간 베스트셀러 (Top 100+)</td></tr>
<tr><td style="text-align:center"><b>핵심 변수</b></td><td>도서명, 출판사, 판매지수, 리뷰수, 평점, 정가</td></tr>
<tr><td style="text-align:center"><b>분석 관점</b></td><td>키워드 빈도, 가격-판매 분포, 독자 참여 패턴 연관성</td></tr>
</tbody>
</table>
...
<div class="section-block">
<h2>2. 제목 키워드 분석 (Keyword Trend Pattern)</h2>
...
<div class="section-block">
<h2>3. 가격대별 판매 성과 패턴 (Price Performance Pattern)</h2>
...
<div class="section-block">
<h2>4. 리뷰 및 판매 지수의 연관성 (Engagement Pattern)</h2>
...
<div class="section-block">
<h2>5. 리뷰 효율성 분석 (Review Efficiency Pattern)</h2>
<div class="insight-box">
<b>리뷰 효율성 공식</b><br>
리뷰 효율성 = 리뷰수 / 판매지수<br>
...
<div class="section-block">
<h2>6. 독자 만족도 패턴 (Rating Trend)</h2>
...
<div class="section-block">
<h2>8. 📌 Action Insight (실무 활용 시사점)</h2>

<div class="section-block">
<h3>1. 키워드 기반 콘텐츠 전략</h3>
...
<div class="section-block">
<h2>9. 종합 결론 및 분석의 한계 (Conclusion & Limitations)</h2>
